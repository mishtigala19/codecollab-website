...
export default function ProjectCard() {
    ...
    return (
        <CardContainer className="flex flex-col md:flex-row items-center md:items-start gap-6 w-full max-w-sm sm:max-w-md md:max-w-none md:w-[48rem] lg:w-[56rem] xl:w-[64rem] mx-auto">
            {/* Left Side Image Div */}
            <div className="flex-shrink-0 w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-72 lg:h-72 bg-[#fbeaea] rounded-full flex items-center justify-center overflow-hidden shadow-inner">
               {projects.avatar ? ( 
                   <img src={projects.avatar} alt="Owner Avatar" className="w-full h-full object-cover"/>
               ) : (
